...
// 👉 THAY BẰNG PACKAGE ID THẬT SAU KHI DEPLOY
...
export const useContract = () => {
  ...
  const state: ContractState = {
    isLoading: isSubmitting, // 🔥 chỉ dùng flag local, không gộp isFetching
    isPending,
    isConfirming: false,
...
- Use Package ID: `0xdedc2d5189c532b9222f4e0213fd0c1a309933f5ee6643ea822379cc3133a656` and Module: `calc`
